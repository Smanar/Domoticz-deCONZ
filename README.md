...
## Changelog.
- xx/xx/xx : 1.0.11 (Beta) > All unknows devices will be reconized as on/off controler, because some working device have "Unknow" as type. Impoving detection for Fan and range extender.   
