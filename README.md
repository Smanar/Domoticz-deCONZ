...
## Changelog.
- xx/xx/xx : 1.0.8 (On beta branch) > continuing new devices implementation. Adding a tool to delete all useless key created everytime launching Phoscon. Setting Websocket port is now useless. 
